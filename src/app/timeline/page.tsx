...
export const CIVILIZATIONS: Civilization[] = [
  ...
  // Southeast Asia
  { id: "southeast-asia", label: "Southeast Asia", color: "#8B7B30", dept: 6, deptMatch: ["Asian"], cultureMatch: ["Thai", "Thailand", "Cambodian", "Cambodia", "Khmer", "Vietnamese", "Vietnam", "Burmese", "Myanmar", "Indonesian", "Indonesia", "Southeast Asian", "Javanese", "Mon", "Cham", "Siamese"],                                                                                                                    group: "Southeast Asia" },
  // South & West Asia
