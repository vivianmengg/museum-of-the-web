...
export const CIVILIZATIONS: Civilization[] = [
  // East Asia
  { id: "china",        label: "China",          color: "#4A7C59", dept: 6,  deptMatch: ["Asian"], cultureMatch: ["Chinese", "China"],                                                                                                                                                                                                                                                                                           group: "East Asia" },
  { id: "japan",        label: "Japan",          color: "#6B4E8A", dept: 6,  deptMatch: ["Asian"], cultureMatch: ["Japanese", "Japan"],                                                                                                                                                                                                                                                                                          group: "East Asia" },
  { id: "korea",        label: "Korea",          color: "#9E5252", dept: 6,  deptMatch: ["Asian"], cultureMatch: ["Korean", "Korea"],                                                                                                                                                                                                                                                                                            group: "East Asia" },
  // Southeast Asia
  { id: "thailand",     label: "Thailand",         color: "#8B7B30", dept: 6, deptMatch: ["Asian"], cultureMatch: ["Thai", "Thailand", "Siamese"],                              group: "Southeast Asia" },
  { id: "cambodia",     label: "Cambodia",         color: "#7A6B20", dept: 6, deptMatch: ["Asian"], cultureMatch: ["Cambodian", "Cambodia", "Khmer"],                           group: "Southeast Asia" },
  { id: "indonesia",    label: "Indonesia",        color: "#9B8B40", dept: 6, deptMatch: ["Asian"], cultureMatch: ["Indonesian", "Indonesia", "Javanese"],                      group: "Southeast Asia" },
  { id: "vietnam",      label: "Vietnam",          color: "#6B8B30", dept: 6, deptMatch: ["Asian"], cultureMatch: ["Vietnamese", "Vietnam", "Champa"],                          group: "Southeast Asia" },
  { id: "myanmar",      label: "Myanmar",          color: "#7B6B50", dept: 6, deptMatch: ["Asian"], cultureMatch: ["Burmese", "Myanmar", "Burma"],                              group: "Southeast Asia" },
  // South & West Asia
  { id: "india",        label: "India",          color: "#B5621E", dept: 6,  deptMatch: ["Asian"], cultureMatch: ["Indian", "India", "South Asian"],                                                                                                                                                                                                                                                                             group: "South & West Asia" },
  { id: "near-east",   label: "Ancient Near East", color: "#8B4513", dept: 3, deptMatch: ["Near Eastern"],                                                                                                                                                                                                                                                                                                                       group: "South & West Asia" },
  { id: "islamic",     label: "Islamic World",   color: "#1E6B7A", dept: 14, deptMatch: ["Islamic"],                                                                                                                                                                                                                                                                                                                             group: "South & West Asia" },
  // Mediterranean & Europe
  { id: "greece-rome", label: "Eastern Mediterranean", color: "#6B4226", dept: 13, deptMatch: ["Greek", "Roman", "Getty Villa"],                                                                                                                                                                                                                                                                                                 group: "Mediterranean & Europe" },
  { id: "europe",      label: "Europe",          color: "#4A5E7A", dept: 11, deptMatch: ["European", "Medieval", "Getty Center"], query: "painting",                                                                                                                                                                                                                                                                             group: "Mediterranean & Europe" },
  // Africa
  { id: "egypt",       label: "Ancient Egypt",   color: "#B8960C", dept: 10, deptMatch: ["Egyptian"],                                                                                                                                                                                                                                                                                                                            group: "Africa" },
  { id: "africa",      label: "Africa",          color: "#7A3E2A", dept: 5,  deptMatch: ["Africa, Oceania"], cultureMatch: ["Yoruba", "Fon", "Benin", "Ife", "Igbo", "Akan", "Asante", "Ashanti", "Bamana", "Dogon", "Fang", "Kongo", "Luba", "Kuba", "Pende", "Chokwe", "Senufo", "Baule", "Dan", "Mangbetu", "Zande", "Swahili", "Amhara", "Ethiopian", "African", "Malian", "Ghanaian", "Nigerian"],                       group: "Africa" },
  // Americas & Oceania
  { id: "americas",    label: "The Americas",    color: "#8B3A2A", dept: 5,  deptMatch: ["Africa, Oceania"], cultureMatch: ["Maya", "Mayan", "Aztec", "Inca", "Olmec", "Mixtec", "Zapotec", "Moche", "Chimú", "Chimu", "Tiwanaku", "Wari", "Nazca", "Teotihuacan", "Mississippian", "Hohokam", "Pueblo", "Native American", "Mexican", "Peruvian", "Colombian", "Costa Rican", "Panamanian"],                                  group: "Americas & Oceania" },
